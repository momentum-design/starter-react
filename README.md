...
5. **Review the example app.**
    ...
    This starter kit includes a working example app. Note how all source code is placed under /src. Tests are placed alongside the file under test. The final built app is placed under /dist. These are the files you run in production.

6. **Having issues?** See [Having Issues?](#having-issues-try-these-things-first).

## Initial Machine Setup

1. **Install [Node 6.0.0 or greater](https://nodejs.org)**

    (6.0 or greater is recommended for optimal build performance)
